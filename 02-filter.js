 ...
 * 📌 MÉTODO: filter()
 * ===============================================================================================================================
 * Função: Percorre o array e SELECIONA apenas os itens que atendam a uma condição (retornam true). Gera um NOVO array com tamanho menor ou igual ao original.
 * ===============================================================================================================================
 */
...
const catalogo = [
    ...
    { id: 101, nome: "Cabo HDMI", categoria: "Acessórios", preco: 30.0, estoque: 0, ativo: false }
];
