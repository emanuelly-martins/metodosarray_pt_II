...
// -------------------------------------------------------------------------------------------------------------------------------
// Exemplo 3 (Back-End Real): Fechamento de pedido com quantidades e cálculo de frete
// -------------------------------------------------------------------------------------------------------------------------------
console.log("--- Exemplo 3: Fechamento de Pedido Relatório (Back-End Real) ---");
...
console.log(`Taxa de Entrega    : R$ ${totalItens.toFixed(2)}`);
console.log(`Total a Pagar      : R$ ${totalItens.toFixed(2)}`);
